...
## 1차 실력 진단 결과
![test-result](/assets/img/test_result.png)

![test-result2](/assets/img/test_result2.png)

* 현재 나의 실력은 총 11 문제 중에 5문제 밖에 풀지 못하는 수준이었고, 창피할 따름이었다. 코드 트리 사이트에서는 내가 어느 카테고리의 문제에서 막혔는지 자세히 알려줬고, 이에 대한 로드맵을 제시해줬다.

![road-map](/assets/img/codetree_4.png)
...
![move-AB](/assets/img/codetree_5.png)
